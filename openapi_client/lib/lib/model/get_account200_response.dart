...
class GetAccount200Response {
  ...
  GetAccount200ResponseData? data;
  ...
  @override
  String toString() => 'GetAccount200Response[success=$success, error=$error, data=$data]';
  ...
  static GetAccount200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetAccount200Response(
        ...
        data: GetAccount200ResponseData.fromJson(json[r'data']),
      );
    }
    return null;
  }
